      ...
      <main className="flex-grow">
        <section className="bg-gradient-to-r from-primary to-primary-dark text-white py-20">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Willkommen bei Synevo</h1>
            <p className="text-xl mb-8">Ihr vertrauenswürdiger Partner für Marketing und Management</p>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12">Unsere Expertise</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card>
                ...
                <CardContent>
                  <p>Wir entwickeln maßgeschneiderte Marketingstrategien, die Ihr Unternehmen voranbringen.</p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
                ...
                <CardContent>
                  <p>Unser erfahrenes Team unterstützt Sie bei der effizienten Führung Ihres Unternehmens.</p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
                ...
                <CardContent>
                  <p>Wir bieten Expertenberatung, um Ihr Unternehmen auf den Erfolg auszurichten.</p>
                </CardContent>
              </Card>
            </div>
          </div>
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-center">
                    <Mail className="mr-2" />
                    <a href="mailto:synergiagroup@zohomail.eu" className="text-primary hover:underline">
                      synergiagroup@zohomail.eu
                    </a>
                  </li>
                  <li className="flex items-center">
                  ...
                  <li className="flex items-center">
                    ...
                    <span>Feuergraben 41, 31785 Hameln</span>
                  </li>
                </ul>
              </div>
              <div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-8">Bleiben Sie informiert</h2>
            <p className="mb-4">Abonnieren Sie unseren Newsletter für die neuesten Updates und Angebote.</p>
            <form className="flex flex-col md:flex-row justify-center items-center gap-4">
              <Input type="email" placeholder="Ihre E-Mail-Adresse" className="max-w-sm" required />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 text-center">
            ...
            <div className="mt-2">
              ...
              <Link href="/agb" className="hover:underline mr-4">AGB</Link>
